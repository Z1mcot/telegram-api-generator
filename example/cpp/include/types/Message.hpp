...
namespace tgbot {
    ...
    struct Message : public MaybeInaccessibleMessage {
        ...
        int64_t reply_to_checklist_task_id;
        ...
        ChecklistTasksDone::Ptr checklist_tasks_done;

        // Optional. Service message: tasks were added to a checklist
        ChecklistTasksAdded::Ptr checklist_tasks_added;
        ...
        GiveawayCompleted::Ptr giveaway_completed;

        // Optional. Service message: the price for paid messages has changed in the chat
        PaidMessagePriceChanged::Ptr paid_message_price_changed;

        // Optional. Service message: a suggested post was approved
        SuggestedPostApproved::Ptr suggested_post_approved;

        // Optional. Service message: approval of a suggested post has failed
        SuggestedPostApprovalFailed::Ptr suggested_post_approval_failed;

        // Optional. Service message: a suggested post was declined
        SuggestedPostDeclined::Ptr suggested_post_declined;

        // Optional. Service message: payment for a suggested post was received
        SuggestedPostPaid::Ptr suggested_post_paid;

        // Optional. Service message: payment for a suggested post was refunded
        SuggestedPostRefunded::Ptr suggested_post_refunded;
