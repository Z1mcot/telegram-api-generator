...
namespace tgbot {
    json InlineQueryResultCachedDocument::to_json() const {
        json j;
        j["type"] = type_;
        j["id"] = id;
        j["title"] = title;
    ...
    std::shared_ptr<InlineQueryResultCachedDocument> InlineQueryResultCachedDocument::from_json(const json& data) {
        ...
        result->document_file_id = data["document_file_id"].get<std::string>();
