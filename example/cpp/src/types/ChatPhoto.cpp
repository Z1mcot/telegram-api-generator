...
namespace tgbot {
    void to_json(json& j, const ChatPhoto& value) {
        j = json{
            {"small_file_id", value.small_file_id},
            {"small_file_unique_id", value.small_file_unique_id},
            {"big_file_id", value.big_file_id},
            {"big_file_unique_id", value.big_file_unique_id}
        };
    }
