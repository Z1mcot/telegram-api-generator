...
namespace tgbot {
    void to_json(json& j, const ChatMemberRestricted& value) {
        j = json{
            ...
            {"can_send_audios", value.can_send_audios},
            {"can_send_documents", value.can_send_documents},
            {"can_send_photos", value.can_send_photos},
            {"can_send_videos", value.can_send_videos},
            {"can_send_video_notes", value.can_send_video_notes},
            {"can_send_voice_notes", value.can_send_voice_notes},
            {"can_send_polls", value.can_send_polls},
            {"can_send_other_messages", value.can_send_other_messages},
            {"can_add_web_page_previews", value.can_add_web_page_previews},
