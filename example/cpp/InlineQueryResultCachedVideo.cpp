...
namespace tgbot {
    json InlineQueryResultCachedVideo::to_json() const {
        json j;
        j["type"] = type_;
        j["id"] = id;
    ...
    std::shared_ptr<InlineQueryResultCachedVideo> InlineQueryResultCachedVideo::from_json(const json& data) {
        ...
        result->video_file_id = data["video_file_id"].get<std::string>();
