...
namespace tgbot {
    json InlineQueryResultCachedGif::to_json() const {
        json j;
        j["type"] = type_;
        j["id"] = id;
    ...
    std::shared_ptr<InlineQueryResultCachedGif> InlineQueryResultCachedGif::from_json(const json& data) {
        ...
        result->gif_file_id = data["gif_file_id"].get<std::string>();
