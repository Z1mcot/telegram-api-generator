...
namespace tgbot {
    ...
    struct InlineKeyboardButton : public TelegramModel {
        ...
        std::shared_ptr<SwitchInlineQueryChosenChat> switch_inline_query_chosen_chat;

        // Optional. Description of the button that copies the specified text to the clipboard.
        std::shared_ptr<CopyTextButton> copy_text;
        ...
        static std::shared_ptr<InlineKeyboardButton> from_json(const json& data);
    };
}
