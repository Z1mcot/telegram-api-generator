...
namespace tgbot {
    json PassportElementErrorTranslationFile::to_json() const {
        json j;
        j["source"] = source;
        j["type"] = type_;
    ...
    std::shared_ptr<PassportElementErrorTranslationFile> PassportElementErrorTranslationFile::from_json(const json& data) {
