...
namespace tgbot {
    json InlineQueryResultCachedAudio::to_json() const {
        json j;
        j["type"] = type_;
        j["id"] = id;
    ...
    std::shared_ptr<InlineQueryResultCachedAudio> InlineQueryResultCachedAudio::from_json(const json& data) {
        ...
        result->audio_file_id = data["audio_file_id"].get<std::string>();
