...
namespace tgbot {
    void to_json(json& j, const AcceptedGiftTypes& value) {
        j = json{
            {"unlimited_gifts", value.unlimited_gifts},
            {"limited_gifts", value.limited_gifts},
            {"unique_gifts", value.unique_gifts},
            {"premium_subscription", value.premium_subscription},
            {"gifts_from_channels", value.gifts_from_channels}
        };
    }
