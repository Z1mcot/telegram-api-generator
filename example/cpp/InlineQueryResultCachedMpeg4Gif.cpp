...
namespace tgbot {
    json InlineQueryResultCachedMpeg4Gif::to_json() const {
        json j;
        j["type"] = type_;
        j["id"] = id;
    ...
    std::shared_ptr<InlineQueryResultCachedMpeg4Gif> InlineQueryResultCachedMpeg4Gif::from_json(const json& data) {
        ...
        result->mpeg4_file_id = data["mpeg4_file_id"].get<std::string>();
