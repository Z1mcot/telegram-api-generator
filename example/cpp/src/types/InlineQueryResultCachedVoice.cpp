...
#include "types/InlineQueryResultCachedVoice.hpp"
#include "types/InlineKeyboardMarkup.hpp"
#include "types/InputMessageContent.hpp"
#include <nlohmann/json.hpp>

namespace tgbot {
    void to_json(json& j, const InlineQueryResultCachedVoice& value) {
        j = json{
            {"type", value.type_},
            {"id", value.id},
            {"voice_file_id", value.voice_file_id},
            {"title", value.title},
    ...
    void from_json(const json& j, InlineQueryResultCachedVoice& value) {
        if (j.contains("type")) {
        ...
        if (j.contains("voice_file_id")) {
            j.at("voice_file_id").get_to(value.voice_file_id);
        }
        if (j.contains("title")) {
