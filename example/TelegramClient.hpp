...
#include "cpp/MessageEffectId.hpp"
#include "cpp/MessageEntity.hpp"
#include "cpp/MessageId.hpp"
#include "cpp/MessageThreadId.hpp"
#include "cpp/OwnedGifts.hpp"
#include "cpp/ParseMode.hpp"
...
public:
     ...
     */
    TelegramResponse<std::vector<std::shared_ptr<Update>>> getUpdates(    std::int64_t offset,
        std::int64_t limit,
        std::int64_t timeout,
        ...
        j["limit"] = limit;
        j["timeout"] = timeout;
        j["allowed_updates"] = allowed_updates;
        std::string body = j.dump();
        std::string response = makeRequest("getUpdates", body);
        return parseResponse<std::vector<std::shared_ptr<Update>>>(response);
    }
    ...
    TelegramResponse<bool> setWebhook(    std::string url,
        ...
        j["allowed_updates"] = allowed_updates;
        j["drop_pending_updates"] = drop_pending_updates;
        j["secret_token"] = secret_token;
        std::string body = j.dump();
     ...
     * @return bool
     */
    TelegramResponse<bool> deleteWebhook(    bool drop_pending_updates
    ) {
        json j;
        j["drop_pending_updates"] = drop_pending_updates;
        std::string body = j.dump();
     ...
     */
    TelegramResponse<std::shared_ptr<WebhookInfo>> getWebhookInfo() {
        std::string response = makeRequest("getWebhookInfo");
        return parseResponse<std::shared_ptr<WebhookInfo>>(response);
    }
     ...
     */
    TelegramResponse<std::shared_ptr<Message>> sendMessage(    ChatId chat_id,
        std::string text,
        ...
        j["direct_messages_topic_id"] = direct_messages_topic_id;
        j["parse_mode"] = parse_mode;
        j["entities"] = entities;
        j["link_preview_options"] = link_preview_options;
        ...
        return parseResponse<std::shared_ptr<Message>>(response);
    }
     ...
     * @return std::shared_ptr<Message>
     */
    TelegramResponse<std::shared_ptr<Message>> forwardMessage(    ChatId chat_id,
        ChatId from_chat_id,
     ...
     */
    TelegramResponse<std::vector<std::shared_ptr<MessageId>>> forwardMessages(    ChatId chat_id,
        ChatId from_chat_id,
        ...
        return parseResponse<std::vector<std::shared_ptr<MessageId>>>(response);
    }
     ...
     */
    TelegramResponse<std::shared_ptr<MessageId>> copyMessage(    ChatId chat_id,
        ChatId from_chat_id,
        MessageId message_id,
        MessageThreadId message_thread_id,
        std::int64_t direct_messages_topic_id,
        ...
        j["caption"] = caption;
        j["parse_mode"] = parse_mode;
        j["caption_entities"] = caption_entities;
        ...
        return parseResponse<std::shared_ptr<MessageId>>(response);
    }
     ...
     * @return std::vector<std::shared_ptr<MessageId>>
     */
    TelegramResponse<std::vector<std::shared_ptr<MessageId>>> copyMessages(    ChatId chat_id,
        ChatId from_chat_id,
        std::vector<MessageId> message_ids,
        MessageThreadId message_thread_id,
        std::int64_t direct_messages_topic_id,
        ...
        j["disable_notification"] = disable_notification;
        j["protect_content"] = protect_content;
        j["remove_caption"] = remove_caption;
        std::string body = j.dump();
     ...
     * @return std::shared_ptr<Message>
     */
    TelegramResponse<std::shared_ptr<Message>> sendPhoto(    ChatId chat_id,
        std::string photo,
        BusinessConnectionId business_connection_id,
        MessageThreadId message_thread_id,
        std::int64_t direct_messages_topic_id,
     ...
     * @return std::shared_ptr<Message>
     */
    TelegramResponse<std::shared_ptr<Message>> sendAudio(    ChatId chat_id,
        std::string audio,
        BusinessConnectionId business_connection_id,
        MessageThreadId message_thread_id,
        std::int64_t direct_messages_topic_id,
     ...
     * @return std::shared_ptr<Message>
     */
    TelegramResponse<std::shared_ptr<Message>> sendDocument(    ChatId chat_id,
        std::string document,
        BusinessConnectionId business_connection_id,
        MessageThreadId message_thread_id,
        std::int64_t direct_messages_topic_id,
     ...
     * @return std::shared_ptr<Message>
     */
    TelegramResponse<std::shared_ptr<Message>> sendVideo(    ChatId chat_id,
        std::string video,
        BusinessConnectionId business_connection_id,
        MessageThreadId message_thread_id,
        std::int64_t direct_messages_topic_id,
     ...
     * @return std::shared_ptr<Message>
     */
    TelegramResponse<std::shared_ptr<Message>> sendAnimation(    ChatId chat_id,
     ...
     * @return std::shared_ptr<Message>
     */
    TelegramResponse<std::shared_ptr<Message>> sendVoice(    ChatId chat_id,
        std::string voice,
        BusinessConnectionId business_connection_id,
        MessageThreadId message_thread_id,
        std::int64_t direct_messages_topic_id,
     ...
     * @return std::shared_ptr<Message>
     */
    TelegramResponse<std::shared_ptr<Message>> sendVideoNote(    ChatId chat_id,
     ...
     * @return std::shared_ptr<Message>
     */
    TelegramResponse<std::shared_ptr<Message>> sendPaidMedia(    ChatId chat_id,
     ...
     */
    TelegramResponse<std::vector<std::shared_ptr<Message>>> sendMediaGroup(    ChatId chat_id,
        ...
        return parseResponse<std::vector<std::shared_ptr<Message>>>(response);
    }
     ...
     * @return std::shared_ptr<Message>
     */
    TelegramResponse<std::shared_ptr<Message>> sendLocation(    ChatId chat_id,
        double latitude,
        double longitude,
        BusinessConnectionId business_connection_id,
        MessageThreadId message_thread_id,
     ...
     * @return std::shared_ptr<Message>
     */
    TelegramResponse<std::shared_ptr<Message>> sendVenue(    ChatId chat_id,
        double latitude,
        double longitude,
        std::string title,
        std::string address,
     ...
     * @return std::shared_ptr<Message>
     */
    TelegramResponse<std::shared_ptr<Message>> sendContact(    ChatId chat_id,
     ...
     * @return std::shared_ptr<Message>
     */
    TelegramResponse<std::shared_ptr<Message>> sendPoll(    ChatId chat_id,
        std::string question,
        ...
        j["business_connection_id"] = business_connection_id;
        j["message_thread_id"] = message_thread_id;
        j["question_parse_mode"] = question_parse_mode;
        j["question_entities"] = question_entities;
        ...
        j["explanation_parse_mode"] = explanation_parse_mode;
        j["explanation_entities"] = explanation_entities;
     ...
     * @return std::shared_ptr<Message>
     */
    TelegramResponse<std::shared_ptr<Message>> sendChecklist(    BusinessConnectionId business_connection_id,
        ChatId chat_id,
     ...
     * @return std::shared_ptr<Message>
     */
    TelegramResponse<std::shared_ptr<Message>> sendDice(    ChatId chat_id,
        BusinessConnectionId business_connection_id,
        MessageThreadId message_thread_id,
        std::int64_t direct_messages_topic_id,
        std::string emoji,
     ...
     */
    TelegramResponse<std::shared_ptr<UserProfilePhotos>> getUserProfilePhotos(    UserId user_id,
        std::int64_t offset,
        std::int64_t limit
    ) {
        json j;
        ...
        return parseResponse<std::shared_ptr<UserProfilePhotos>>(response);
    }
     ...
     */
    TelegramResponse<std::shared_ptr<File>> getFile(    std::string file_id
    ) {
        json j;
        j["file_id"] = file_id;
        std::string body = j.dump();
        std::string response = makeRequest("getFile", body);
        return parseResponse<std::shared_ptr<File>>(response);
    }
    ...
    TelegramResponse<bool> banChatMember(    ChatId chat_id,
        ...
        j["revoke_messages"] = revoke_messages;
        std::string body = j.dump();
    ...
    TelegramResponse<bool> unbanChatMember(    ChatId chat_id,
        ...
        j["chat_id"] = chat_id;
        j["user_id"] = user_id;
        j["only_if_banned"] = only_if_banned;
        std::string body = j.dump();
    ...
    TelegramResponse<bool> restrictChatMember(    ChatId chat_id,
        ...
        j["use_independent_chat_permissions"] = use_independent_chat_permissions;
        j["until_date"] = until_date;
        std::string body = j.dump();
     ...
     */
    TelegramResponse<std::shared_ptr<ChatInviteLink>> createChatInviteLink(    ChatId chat_id,
        std::string name,
        std::int64_t expire_date,
        std::int64_t member_limit,
        ...
        return parseResponse<std::shared_ptr<ChatInviteLink>>(response);
    }
     ...
     * @return std::shared_ptr<ChatInviteLink>
     */
    TelegramResponse<std::shared_ptr<ChatInviteLink>> editChatInviteLink(    ChatId chat_id,
     ...
     * @return std::shared_ptr<ChatInviteLink>
     */
    TelegramResponse<std::shared_ptr<ChatInviteLink>> createChatSubscriptionInviteLink(    ChatId chat_id,
     ...
     * @return std::shared_ptr<ChatInviteLink>
     */
    TelegramResponse<std::shared_ptr<ChatInviteLink>> editChatSubscriptionInviteLink(    ChatId chat_id,
        std::string invite_link,
        std::string name
    ) {
        json j;
     ...
     * @return std::shared_ptr<ChatInviteLink>
     */
    TelegramResponse<std::shared_ptr<ChatInviteLink>> revokeChatInviteLink(    ChatId chat_id,
        std::string invite_link
    ) {
        json j;
        j["chat_id"] = chat_id;
     ...
     */
    TelegramResponse<std::shared_ptr<ChatFullInfo>> getChat(    ChatId chat_id
    ) {
        json j;
        j["chat_id"] = chat_id;
        std::string body = j.dump();
        std::string response = makeRequest("getChat", body);
        return parseResponse<std::shared_ptr<ChatFullInfo>>(response);
    }
     ...
     */
    TelegramResponse<std::vector<std::shared_ptr<ChatMember>>> getChatAdministrators(    ChatId chat_id
    ) {
        json j;
        j["chat_id"] = chat_id;
        std::string body = j.dump();
        std::string response = makeRequest("getChatAdministrators", body);
        return parseResponse<std::vector<std::shared_ptr<ChatMember>>>(response);
    }
     ...
     */
    TelegramResponse<std::shared_ptr<Int>> getChatMemberCount(    ChatId chat_id
    ) {
        json j;
        j["chat_id"] = chat_id;
        std::string body = j.dump();
        std::string response = makeRequest("getChatMemberCount", body);
        return parseResponse<std::shared_ptr<Int>>(response);
    }
     ...
     */
    TelegramResponse<std::shared_ptr<ChatMember>> getChatMember(    ChatId chat_id,
        UserId user_id
    ) {
        json j;
        j["chat_id"] = chat_id;
        ...
        return parseResponse<std::shared_ptr<ChatMember>>(response);
    }
     ...
     */
    TelegramResponse<std::vector<std::shared_ptr<Sticker>>> getForumTopicIconStickers() {
        std::string response = makeRequest("getForumTopicIconStickers");
        return parseResponse<std::vector<std::shared_ptr<Sticker>>>(response);
    }
     ...
     */
    TelegramResponse<std::shared_ptr<ForumTopic>> createForumTopic(    ChatId chat_id,
        std::string name,
        ...
        return parseResponse<std::shared_ptr<ForumTopic>>(response);
    }
    ...
    TelegramResponse<bool> answerCallbackQuery(    std::string callback_query_id,
        ...
        bool show_alert,
        std::string url,
        std::int64_t cache_time
    ) {
        json j;
        j["callback_query_id"] = callback_query_id;
        j["text"] = text;
        j["show_alert"] = show_alert;
        j["url"] = url;
        j["cache_time"] = cache_time;
        std::string body = j.dump();
     ...
     */
    TelegramResponse<std::shared_ptr<UserChatBoosts>> getUserChatBoosts(    ChatId chat_id,
        UserId user_id
    ) {
        json j;
        j["chat_id"] = chat_id;
        ...
        return parseResponse<std::shared_ptr<UserChatBoosts>>(response);
    }
     ...
     */
    TelegramResponse<std::shared_ptr<BusinessConnection>> getBusinessConnection(    BusinessConnectionId business_connection_id
    ) {
        json j;
        j["business_connection_id"] = business_connection_id;
        std::string body = j.dump();
        std::string response = makeRequest("getBusinessConnection", body);
        return parseResponse<std::shared_ptr<BusinessConnection>>(response);
    }
     ...
     * @return bool
     */
    TelegramResponse<bool> setMyCommands(    std::vector<std::shared_ptr<BotCommand>> commands,
     ...
     * @return bool
     */
    TelegramResponse<bool> deleteMyCommands(    std::shared_ptr<BotCommandScope> scope,
        std::string language_code
    ) {
        json j;
        j["scope"] = scope;
     ...
     */
    TelegramResponse<std::vector<std::shared_ptr<BotCommand>>> getMyCommands(    std::shared_ptr<BotCommandScope> scope,
        std::string language_code
    ) {
        json j;
        j["scope"] = scope;
        ...
        return parseResponse<std::vector<std::shared_ptr<BotCommand>>>(response);
    }
     ...
     * @return bool
     */
    TelegramResponse<bool> setMyName(    std::string name,
        std::string language_code
    ) {
        json j;
        j["name"] = name;
     ...
     */
    TelegramResponse<std::shared_ptr<BotName>> getMyName(    std::string language_code
    ) {
        json j;
        j["language_code"] = language_code;
        std::string body = j.dump();
        std::string response = makeRequest("getMyName", body);
        return parseResponse<std::shared_ptr<BotName>>(response);
    }
     ...
     * @return bool
     */
    TelegramResponse<bool> setMyDescription(    std::string description,
        std::string language_code
    ) {
        json j;
        j["description"] = description;
     ...
     */
    TelegramResponse<std::shared_ptr<BotDescription>> getMyDescription(    std::string language_code
    ) {
        json j;
        j["language_code"] = language_code;
        std::string body = j.dump();
        std::string response = makeRequest("getMyDescription", body);
        return parseResponse<std::shared_ptr<BotDescription>>(response);
    }
     ...
     * @return bool
     */
    TelegramResponse<bool> setMyShortDescription(    std::string short_description,
        std::string language_code
    ) {
        json j;
     ...
     */
    TelegramResponse<std::shared_ptr<BotShortDescription>> getMyShortDescription(    std::string language_code
    ) {
        json j;
        j["language_code"] = language_code;
        std::string body = j.dump();
        std::string response = makeRequest("getMyShortDescription", body);
        return parseResponse<std::shared_ptr<BotShortDescription>>(response);
    }
     ...
     * @return bool
     */
    TelegramResponse<bool> setChatMenuButton(    ChatId chat_id,
        std::shared_ptr<MenuButton> menu_button
    ) {
        json j;
        j["chat_id"] = chat_id;
        j["menu_button"] = menu_button;
        std::string body = j.dump();
     ...
     */
    TelegramResponse<std::shared_ptr<MenuButton>> getChatMenuButton(    ChatId chat_id
    ) {
        json j;
        j["chat_id"] = chat_id;
        std::string body = j.dump();
        std::string response = makeRequest("getChatMenuButton", body);
        return parseResponse<std::shared_ptr<MenuButton>>(response);
    }
     ...
     * @return bool
     */
    TelegramResponse<bool> setMyDefaultAdministratorRights(    std::shared_ptr<ChatAdministratorRights> rights,
        bool for_channels
    ) {
        json j;
        j["rights"] = rights;
        j["for_channels"] = for_channels;
        std::string body = j.dump();
     ...
     */
    TelegramResponse<std::shared_ptr<ChatAdministratorRights>> getMyDefaultAdministratorRights(    bool for_channels
    ) {
        json j;
        j["for_channels"] = for_channels;
        std::string body = j.dump();
        std::string response = makeRequest("getMyDefaultAdministratorRights", body);
        return parseResponse<std::shared_ptr<ChatAdministratorRights>>(response);
    }
    ...
    TelegramResponse<bool> sendGift(    std::string gift_id,
        ...
        j["user_id"] = user_id;
        j["chat_id"] = chat_id;
        j["pay_for_upgrade"] = pay_for_upgrade;
        j["text"] = text;
        j["text_parse_mode"] = text_parse_mode;
        j["text_entities"] = text_entities;
        std::string body = j.dump();
    ...
    TelegramResponse<bool> verifyUser(    UserId user_id,
        ...
        json j;
        j["user_id"] = user_id;
        j["custom_description"] = custom_description;
        std::string body = j.dump();
     ...
     */
    TelegramResponse<std::shared_ptr<StarAmount>> getBusinessAccountStarBalance(    BusinessConnectionId business_connection_id
    ) {
        json j;
        j["business_connection_id"] = business_connection_id;
        std::string body = j.dump();
        std::string response = makeRequest("getBusinessAccountStarBalance", body);
        return parseResponse<std::shared_ptr<StarAmount>>(response);
    }
     ...
     */
    TelegramResponse<std::shared_ptr<OwnedGifts>> getBusinessAccountGifts(    BusinessConnectionId business_connection_id,
    ...
    TelegramResponse<bool> upgradeGift(    BusinessConnectionId business_connection_id,
        ...
        j["business_connection_id"] = business_connection_id;
        j["owned_gift_id"] = owned_gift_id;
        j["keep_original_details"] = keep_original_details;
        j["star_count"] = star_count;
        std::string body = j.dump();
     ...
     */
    TelegramResponse<std::shared_ptr<Story>> postStory(    BusinessConnectionId business_connection_id,
     ...
     * @return std::shared_ptr<Story>
     */
    TelegramResponse<std::shared_ptr<Story>> editStory(    BusinessConnectionId business_connection_id,
     ...
     * @return std::shared_ptr<Message>
     */
    TelegramResponse<std::shared_ptr<Message>> editMessageText(    std::string text,
        BusinessConnectionId business_connection_id,
        ChatId chat_id,
        MessageId message_id,
     ...
     * @return std::shared_ptr<Message>
     */
    TelegramResponse<std::shared_ptr<Message>> editMessageCaption(    BusinessConnectionId business_connection_id,
        ChatId chat_id,
        MessageId message_id,
        std::string inline_message_id,
        std::string caption,
     ...
     * @return std::shared_ptr<Message>
     */
    TelegramResponse<std::shared_ptr<Message>> editMessageMedia(    std::shared_ptr<InputMedia> media,
        BusinessConnectionId business_connection_id,
        ChatId chat_id,
        MessageId message_id,
        std::string inline_message_id,
     ...
     * @return std::shared_ptr<Message>
     */
    TelegramResponse<std::shared_ptr<Message>> editMessageLiveLocation(    double latitude,
        double longitude,
        BusinessConnectionId business_connection_id,
        ChatId chat_id,
        MessageId message_id,
     ...
     * @return std::shared_ptr<Message>
     */
    TelegramResponse<std::shared_ptr<Message>> stopMessageLiveLocation(    BusinessConnectionId business_connection_id,
        ChatId chat_id,
        MessageId message_id,
        std::string inline_message_id,
        std::shared_ptr<InlineKeyboardMarkup> reply_markup
     ...
     * @return std::shared_ptr<Message>
     */
    TelegramResponse<std::shared_ptr<Message>> editMessageChecklist(    BusinessConnectionId business_connection_id,
        ChatId chat_id,
        MessageId message_id,
        std::shared_ptr<InputChecklist> checklist,
        std::shared_ptr<InlineKeyboardMarkup> reply_markup
     ...
     * @return std::shared_ptr<Message>
     */
    TelegramResponse<std::shared_ptr<Message>> editMessageReplyMarkup(    BusinessConnectionId business_connection_id,
        ChatId chat_id,
        MessageId message_id,
        std::string inline_message_id,
        std::shared_ptr<InlineKeyboardMarkup> reply_markup
     ...
     */
    TelegramResponse<std::shared_ptr<Poll>> stopPoll(    ChatId chat_id,
        MessageId message_id,
        BusinessConnectionId business_connection_id,
        std::shared_ptr<InlineKeyboardMarkup> reply_markup
    ) {
        ...
        return parseResponse<std::shared_ptr<Poll>>(response);
    }
     ...
     * @return std::shared_ptr<Message>
     */
    TelegramResponse<std::shared_ptr<Message>> sendSticker(    ChatId chat_id,
        std::string sticker,
        BusinessConnectionId business_connection_id,
        MessageThreadId message_thread_id,
        std::int64_t direct_messages_topic_id,
     ...
     */
    TelegramResponse<std::shared_ptr<StickerSet>> getStickerSet(    std::string name
    ) {
        json j;
        j["name"] = name;
        std::string body = j.dump();
        std::string response = makeRequest("getStickerSet", body);
        return parseResponse<std::shared_ptr<StickerSet>>(response);
    }
     ...
     * @return std::vector<std::shared_ptr<Sticker>>
     */
    TelegramResponse<std::vector<std::shared_ptr<Sticker>>> getCustomEmojiStickers(    std::vector<std::string> custom_emoji_ids
    ) {
        json j;
     ...
     * @return std::shared_ptr<File>
     */
    TelegramResponse<std::shared_ptr<File>> uploadStickerFile(    UserId user_id,
     ...
     */
    TelegramResponse<std::shared_ptr<SentWebAppMessage>> answerWebAppQuery(    std::string web_app_query_id,
        ...
        return parseResponse<std::shared_ptr<SentWebAppMessage>>(response);
    }
     ...
     */
    TelegramResponse<std::shared_ptr<PreparedInlineMessage>> savePreparedInlineMessage(    UserId user_id,
        std::shared_ptr<InlineQueryResult> result,
        ...
        return parseResponse<std::shared_ptr<PreparedInlineMessage>>(response);
    }
     ...
     * @return std::shared_ptr<Message>
     */
    TelegramResponse<std::shared_ptr<Message>> sendInvoice(    ChatId chat_id,
        std::string title,
        std::string description,
        std::string payload,
        std::string currency,
        ...
        std::int64_t max_tip_amount,
        std::vector<std::int64_t> suggested_tip_amounts,
        std::string start_parameter,
        std::string provider_data,
        std::string photo_url,
        std::int64_t photo_size,
        std::int64_t photo_width,
        std::int64_t photo_height,
        bool need_name,
        ...
        j["suggested_tip_amounts"] = suggested_tip_amounts;
    ...
    TelegramResponse<bool> answerShippingQuery(    std::string shipping_query_id,
        ...
        j["ok"] = ok;
        j["shipping_options"] = shipping_options;
     ...
     */
    TelegramResponse<std::shared_ptr<StarTransactions>> getStarTransactions(    std::int64_t offset,
        std::int64_t limit
    ) {
        json j;
        j["offset"] = offset;
        ...
        return parseResponse<std::shared_ptr<StarTransactions>>(response);
    }
     ...
     * @return std::shared_ptr<Message>
     */
    TelegramResponse<std::shared_ptr<Message>> sendGame(    ChatId chat_id,
     ...
     * @return std::shared_ptr<Message>
     */
    TelegramResponse<std::shared_ptr<Message>> setGameScore(    UserId user_id,
        std::int64_t score,
        bool force,
        ...
        j["score"] = score;
        j["force"] = force;
        j["disable_edit_message"] = disable_edit_message;
        j["chat_id"] = chat_id;
        j["message_id"] = message_id;
        j["inline_message_id"] = inline_message_id;
        std::string body = j.dump();
     ...
     */
    TelegramResponse<std::vector<std::shared_ptr<GameHighScore>>> getGameHighScores(    UserId user_id,
        ChatId chat_id,
        MessageId message_id,
        std::string inline_message_id
    ) {
        ...
        return parseResponse<std::vector<std::shared_ptr<GameHighScore>>>(response);
    }
