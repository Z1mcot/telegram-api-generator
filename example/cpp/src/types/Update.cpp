...
namespace tgbot {
    void to_json(json& j, const Update& value) {
        j = json{
            ...
            {"edited_message", value.edited_message},
            {"channel_post", value.channel_post},
            {"edited_channel_post", value.edited_channel_post},
            {"business_connection", value.business_connection},
            {"business_message", value.business_message},
            {"edited_business_message", value.edited_business_message},
            {"deleted_business_messages", value.deleted_business_messages},
            {"message_reaction", value.message_reaction},
            {"message_reaction_count", value.message_reaction_count},
            {"inline_query", value.inline_query},
            {"chosen_inline_result", value.chosen_inline_result},
            {"callback_query", value.callback_query},
            {"shipping_query", value.shipping_query},
            {"pre_checkout_query", value.pre_checkout_query},
            {"purchased_paid_media", value.purchased_paid_media},
            {"poll", value.poll},
            {"poll_answer", value.poll_answer},
            {"my_chat_member", value.my_chat_member},
            {"chat_member", value.chat_member},
            {"chat_join_request", value.chat_join_request},
            {"chat_boost", value.chat_boost},
            {"removed_chat_boost", value.removed_chat_boost}
        };
    }
