...
namespace tgbot {
    void to_json(json& j, const ReplyParameters& value) {
        j = json{
            ...
            {"allow_sending_without_reply", value.allow_sending_without_reply},
            {"quote", value.quote},
            {"quote_parse_mode", value.quote_parse_mode},
            {"quote_entities", value.quote_entities},
            {"quote_position", value.quote_position},
            {"checklist_task_id", value.checklist_task_id}
        };
    }
